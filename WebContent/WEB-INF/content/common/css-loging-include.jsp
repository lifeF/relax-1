...
<link rel="icon" type="image/png" sizes="16x16" href="<s:url value='/images/img.png' />" />
...
<link href="<s:url value="/css/n1.css" includeParams="none"/>" rel="stylesheet" type="text/css">
