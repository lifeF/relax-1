...
<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
	<div class="menu_section">
		...
		<ul class="nav side-menu">
			...
			<li><a><i class="fa fa-users"></i> Patients</a></li>
			
			<li><a><i class="fa fa-address-book"></i> Departments</a></li>
			...
			<li><a><i class="fa fa-medkit"></i>ICU</a></li>
			
			<li><s:url var="DiaDashboardUrl" action="Diagnostic.html" namespace="/"></s:url> 
					<s:a href="%{#DiaDashboardUrl}">
						<i class=" fa fa-pie-chart "></i>Diagnostic
					</s:a>
					</li>
		</ul>
	</div>
